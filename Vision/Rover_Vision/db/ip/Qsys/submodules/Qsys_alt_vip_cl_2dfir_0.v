...
module Qsys_alt_vip_cl_2dfir_0 (
	...
	wire          input_demux_av_st_dout_0_valid;         // input_demux:av_st_dout_valid_0 -> in_gb:av_st_din_valid
	wire   [55:0] input_demux_av_st_dout_0_data;          // input_demux:av_st_dout_data_0 -> in_gb:av_st_din_data
	wire          input_demux_av_st_dout_0_ready;         // in_gb:av_st_din_ready -> input_demux:av_st_dout_ready_0
	wire          input_demux_av_st_dout_0_startofpacket; // input_demux:av_st_dout_startofpacket_0 -> in_gb:av_st_din_startofpacket
	wire          input_demux_av_st_dout_0_endofpacket;   // input_demux:av_st_dout_endofpacket_0 -> in_gb:av_st_din_endofpacket
	wire          in_gb_av_st_dout_valid;                 // in_gb:av_st_dout_valid -> line_buffer:av_st_din_valid
	wire   [55:0] in_gb_av_st_dout_data;                  // in_gb:av_st_dout_data -> line_buffer:av_st_din_data
	wire          in_gb_av_st_dout_ready;                 // line_buffer:av_st_din_ready -> in_gb:av_st_dout_ready
	wire          in_gb_av_st_dout_startofpacket;         // in_gb:av_st_dout_startofpacket -> line_buffer:av_st_din_startofpacket
	wire          in_gb_av_st_dout_endofpacket;           // in_gb:av_st_dout_endofpacket -> line_buffer:av_st_din_endofpacket
	...
	alt_vip_line_buffer #(
		...
		.av_st_din_valid          (in_gb_av_st_dout_valid),                  //    av_st_din.valid
		.av_st_din_startofpacket  (in_gb_av_st_dout_startofpacket),          //             .startofpacket
		.av_st_din_endofpacket    (in_gb_av_st_dout_endofpacket),            //             .endofpacket
		.av_st_din_data           (in_gb_av_st_dout_data),                   //             .data
		.av_st_din_ready          (in_gb_av_st_dout_ready),                  //             .ready
	...
	alt_vip_guard_bands_alg_core #(
		...
		.av_st_dout_valid         (in_gb_av_st_dout_valid),                 // av_st_dout.valid
		.av_st_dout_startofpacket (in_gb_av_st_dout_startofpacket),         //           .startofpacket
		.av_st_dout_endofpacket   (in_gb_av_st_dout_endofpacket),           //           .endofpacket
		.av_st_dout_data          (in_gb_av_st_dout_data),                  //           .data
		.av_st_dout_ready         (in_gb_av_st_dout_ready)                  //           .ready
	);
